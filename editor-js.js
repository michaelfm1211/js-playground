! function() {
    ...
    1: [function(t, e, r) {
        ! function() {
            "use strict";
            var e, r, n = t("./editor-libs/feature-detector.js"),
            ...
            }!document.all && n.isDefined(a) && (document.documentElement.classList.add("js"), s.dataset.height && document.getElementById("editor").classList.add(s.dataset.height), document.getElementById("static").classList.add("hidden"), document.getElementById("live").classList.remove("hidden"), o(), i.register(), r = document.getElementById("editor"), e = CodeMirror(r, {
    ...
    2: [function(t, e, r) {
        ...
        e.exports = {
            ...
            toggleClippy: function(t) {
                "use strict";
                for (var e = t.querySelector(".copy"), r = document.querySelectorAll(".copy"), n = 0, o = r.length; n < o; n++) r[n].classList.add("hidden"), r[n].setAttribute("aria-hidden", !0);
    ...
    3: [function(t, e, r) {
        e.exports = {
            formatArray: function(t) {
                "use strict";
                for (var e = "", r = 0, n = t.length; r < n; r++) "string" == typeof t[r] ? e += '"' + t[r] + '"' : Array.isArray(t[r]) ? (e += "Array [", e += this.formatArray(t[r]), e += "]") : e += this.formatOutput(t[r]), r < t.length - 1 && (e += ", ");
                return e
            },
            formatObject: function(t) {
                ...
                if (e.match && e.match(/^(ArrayBuffer|SharedArrayBuffer|DataView)$/)) return e + " {}";
                if (e.match && e.match(/^(Int8Array|Int16Array|Int32Array|Uint8Array|Uint16Array|Uint32Array|Uint8ClampedArray|Float32Array|Float64Array|BigInt64Array|BigUint64Array)$/)) return t.length > 0 ? e + " [" + this.formatArray(t) + "]" : e + " []";
                if ("Symbol" === e && void 0 !== t) return t.toString();
                if ("Object" === e) {
                    var r = "",
                        n = !0;
                    for (var o in t) t.hasOwnProperty(o) && (n ? n = !1 : r += ", ", r = r + o + ": " + this.formatOutput(t[o]));
                    return e + " { " + r + " }"
                }
                if (!t.constructor && !t.prototype) {
                    r = "", n = !0;
                    for (var o in t) n ? n = !1 : r += ", ", r = r + o + ": " + this.formatOutput(t[o]);
                    return "Object { " + r + " }"
                }
                return t
            },
    ...
    5: [function(t, e, r) {
        e.exports = {
            ...
            applyCode: function(t, e, r) {
                ...
                t.replace(/(\/\*)[\s\S]+(\*\/)/g, ""), n.style.cssText = t, clearTimeout(this.editTimer), this.editTimer = setTimeout(function() {
                    n.style.cssText ? e.parentNode.classList.remove("invalid") : e.parentNode.classList.add("invalid")
                }, 500)
            },
            choose: function(t) {
                var r = t.querySelector("code");
                t.classList.add("selected"), r.setAttribute("contentEditable", !0), r.setAttribute("spellcheck", !1), e.exports.applyCode(r.textContent, t)
            },
            resetDefault: function() {
                var t = document.getElementById("default-example"),
                    r = document.getElementById("output");
                if (t.classList.contains("hidden")) {
                    for (var n = r.querySelectorAll("section"), o = 0, i = n.length; o < i; o++) n[o].classList.add("hidden"), n[o].setAttribute("aria-hidden", !0);
                    t.classList.remove("hidden"), t.setAttribute("aria-hidden", !1)
                }
                e.exports.resetUIState()
            },
            resetUIState: function() {
                for (var t = document.getElementById("example-choice-list").querySelectorAll(".example-choice"), e = 0, r = t.length; e < r; e++) t[e].classList.remove("selected")
            }
        }
    }, {}],
    6: [function(t, e, r) {
                ...
                ! function() {
                    window.addEventListener("message", function(t) {
                        if (void 0 !== t.data.theme) {
                            ...
                            e.classList.add("theme-" + t.data.theme), localStorage.setItem("theme", t.data.theme)
                        }
                    }, !1)
                }(), "loading" != document.readyState ? i() : document.addEventListener("DOMContentLoaded", i), t && function(t) {
                    t.addEventListener("cut", s), t.addEventListener("copy", s), t.addEventListener("paste", a), t.addEventListener("keyup", function(t) {
    ...
    8: [function(t, e, r) {
        e.exports = {
            findParentChoiceElem: function(t) {
                "use strict";
                for (var e = t.parentElement, r = e.classList; e && !r.contains("example-choice");) r = (e = e.parentElement).classList;
                return e
            },
            isPropertySupported: function(t) {
                "use strict";
                if (void 0 === t.property) return !0;
                for (var e = t.property.split(" "), r = !1, n = document.createElement("div"), o = 0, i = e.length; o < i; o++) void 0 !== n.style[e[o]] && (r = !0);
                return r
            },
